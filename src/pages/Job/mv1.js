        ...
        return (
            ...
            <div>
                ...
                <button style={{width:'95px',height:'35px',backgroundColor:'yellow',color:'red',marginLeft:'20px',marginTop:'60px'}}  onClick={() => this.RejectHandler(this.props.match.params.id)}>Reject</button> */}
                    ...
                    <Link to={"/job/View/" + data.id}><button style={{ width: '95px', height: '35px', backgroundColor: '#4672bb', marginLeft: '500px', marginTop: '80px', borderColor: 'gray', color: 'white' }}>Back</button></Link>
                </div>
            </div>
        )
    }
