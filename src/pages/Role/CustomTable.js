...
import EditableCell from '../../components/InlineCustomTable/EditableCell';
import EditableFormRow from '../../components/InlineCustomTable/EditableRow';
import EditableContext from '../../components/InlineCustomTable/Context';
import {
  Table,
  message,
  Popconfirm,
...
import Button from '../../components/InlineCustomTable/Button';
import '../../components/InlineCustomTable/index.css';
        ...
        return (
          <div>
            ...
            {this.state.editable ? (
              ...
              <Link to="/role/RP"> <span style={{ color: '#52c41a' }}>  permission</span>
              </Link>
