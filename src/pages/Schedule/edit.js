...
import SelectEditTable from './selectEditTable'
...
class Schedule extends React.Component {
	...
	render() {
		...
		return (
			<div>
				<h2 style={{ color: 'blue' }}>Edit Schedule</h2>
				<h4>
				...
				<div className="ScheduleContainer">
					...
					<div style={{ paddingTop: '36px' }}>
						...
						{/* <Row style={{marginLeft:'30%',marginTop:'30px'}}> <Pagination defaultCurrent={6} total={300} marginRight/></Row> */}
					</div>
				</div>
				...
				<div className="ScheduleContainer">
					...
					<SelectEditTable schedule={schedule} dataSource={employeelist} />
				</div>
			</div>
		)
	}
